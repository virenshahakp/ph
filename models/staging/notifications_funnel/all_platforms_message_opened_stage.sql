...
opened_messages as (
  ...
  {{ dbt_utils.union_relations(
      relations=[
        ...
        , ref('androidtv_prod_message_opened_stage')
        , ref('fire_prod_message_opened_stage')
        , ref('fire_tv_prod_message_opened_stage')        
        , ref('ios_prod_message_opened_stage')
        , ref('roku_prod_message_opened_stage')
        , ref('tvos_prod_message_opened_stage')
        , ref('web_prod_message_opened_stage')
      ]
    )
  }}
