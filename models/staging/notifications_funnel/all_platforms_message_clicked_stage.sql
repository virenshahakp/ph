...
clicked_messages as (
  ...
  {{ dbt_utils.union_relations(
      relations=[
        ...
        , ref('androidtv_prod_message_clicked_stage')
        , ref('fire_prod_message_clicked_stage')
        , ref('fire_tv_prod_message_clicked_stage')
        , ref('ios_prod_message_clicked_stage')
        , ref('roku_prod_message_clicked_stage')
        , ref('tvos_prod_message_clicked_stage')
        , ref('web_prod_message_clicked_stage')
      ]
    )
  }}
