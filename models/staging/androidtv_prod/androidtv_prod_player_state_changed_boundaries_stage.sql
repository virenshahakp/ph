...
playback_sessions_to_process as (
  ...
  from {{ ref('androidtv_prod_player_state_changed_stage') }}
  {%- if is_incremental() %}
...
, events_to_process as (
  ...
  select
    androidtv_prod_player_state_changed_stage.event_id
    , androidtv_prod_player_state_changed_stage.user_id
    , androidtv_prod_player_state_changed_stage.playback_session_id
    , androidtv_prod_player_state_changed_stage.received_at
    , androidtv_prod_player_state_changed_stage."timestamp"
    , androidtv_prod_player_state_changed_stage.delay
    , androidtv_prod_player_state_changed_stage.position_start
    , androidtv_prod_player_state_changed_stage.position_stop
    , androidtv_prod_player_state_changed_stage.hashed_session_id
    , androidtv_prod_player_state_changed_stage.context_ip
    , androidtv_prod_player_state_changed_stage.action
    , androidtv_prod_player_state_changed_stage.bitrate
    , androidtv_prod_player_state_changed_stage.loaded_at
    /*
    ...
    */
    , case
      when regexp_count(androidtv_prod_player_state_changed_stage.decoded_asset_id, ':') > 1
        then f_base64encode(
            split_part(
              androidtv_prod_player_state_changed_stage.decoded_asset_id, ':', 1
            ) || ':'
            || split_part(
              androidtv_prod_player_state_changed_stage.decoded_asset_id, ':', 2
            )
          )
      else androidtv_prod_player_state_changed_stage.asset_id
    end                                                                                                      as asset_id
  from {{ ref('androidtv_prod_player_state_changed_stage') }}
