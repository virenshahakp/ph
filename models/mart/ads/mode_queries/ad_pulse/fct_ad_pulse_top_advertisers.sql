...
with report_data as (
  select
    ...
    , case 
      when ad_seconds::float = 0 
        then 0 
      when ad_seconds::float is null 
        then null 
      else ecpm::float / ad_seconds::float 
    end 
    as ecpm_per_impression_second


    , case 
      when impressions::float = 0 
        then 0 
      when impressions::float is null 
        then null 
      else ad_revenue::float / impressions::float 
    end 
    as ave_revenue_per_impression
    ...
    as ave_revenue_per_impression_second
  ...
  from {{ ref ('fct_ad_pulse_top_advertisers_pre') }}
...
, final as (
  select
    ...
    as impressions__1_day_percent_of_total
    , case 
      when 
    ...
    as impressions__percent_difference_from__previous_1_day
    , case 
      when 
    ...
    as impressions__7_day_percent_of_total
    , case 
      when impressions_7_day__previous_7_day = 0 
        then null 
      else 
        (
    ...
    as impressions_7_day__percent_difference_from__previous_7_day
    ...
    as impressions__30_day_percent_of_total
    , case 
      when 
    ...
    as impressions_30_day__percent_difference_from__previous_30_day
    , case 
      when 
    ...
    as ad_revenue__1_day_percent_of_total
    , case 
      when ad_revenue__previous_1_day = 0 
        then null 
      else 
        (ad_revenue::float - ad_revenue__previous_1_day::float) / ad_revenue__previous_1_day::float 
    end 
    as ad_revenue__percent_difference_from__previous_1_day
    ...
    as ad_revenue__7_day_percent_of_total
    , case 
      when 
    ...
    as ad_revenue_7_day__percent_difference_from__previous_7_day
    , case 
      when 
    ...
    as ad_revenue__30_day_percent_of_total
    , case 
      when 
    ...
    as ad_revenue_30_day__percent_difference_from__previous_30_day
