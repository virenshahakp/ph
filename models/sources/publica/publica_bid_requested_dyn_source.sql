...
select
  ...
  , custom__custom1
  , custom__custom3
  , custom__header__accept
  , "custom__header__accept-_encoding"       as custom__header__accept_encoding
  , "custom__header__accept-_language"       as custom__header__accept_language
  , "custom__header__content-_type"          as custom__header__content_type
  , custom__header__dnt
  , "custom__header__user-_agent"            as custom__header__user_agent
  , "custom__header__x-_forwarded-_for"      as custom__header__x_forwarded_for
  , "custom__header__x-_openrtb-_version"    as custom__header__x_openrtb_version
  , custom__host
...
from {{ source('publica', 'bid_requested_dyn') }}